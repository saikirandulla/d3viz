...
var tip = d3.tip()
    .attr('class', 'd3-tip')
    .offset([-10, width- 750])
    .html(function(d) { return "County: " +d.county+"; "+" Population: "+d.population+"; "+" Felony rate: "+d.felony+"; "+" Misdemeanor rate: "+d.misdemeanor; })
...
d3.json("data/formatted_counties.json", function(counties) {
  ...
  // Add a title.
  //dot.append("title")
   //   .html(function(d) { return "County: " +d.county+"\n\n"+"Felonies relative to state average: "+d.felony+"\n\n"+"Misdemeanors relative to state average: "+d.misdemeanor+"\n\n"+"Population: "+d.population; });
